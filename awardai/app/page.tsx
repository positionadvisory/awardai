...
const COUNTDOWN_SHOWS = [
  { name: 'Cannes Lions',  date: new Date('2026-04-17T23:59:59'), region: 'Global' },
  { name: 'Effies APAC',  date: new Date('2026-06-12T23:59:59'), region: 'Asia Pacific' },
  { name: 'Spikes Asia',  date: new Date('2026-07-31T23:59:59'), region: 'Asia Pacific' },
]
