...
export const SHOW_CATEGORIES: Record<string, string[]> = {
  ...
  // 2027 list, 34 categories, read from the organizer 13 Sep 2026. 2026 to 2027 delta: 2 renamed, 1 dropped, 2 new.
  'Festival of Media APAC': [
    ...
    'Best Event or Experiential Campaign', 'Best Integrated Campaign',
    'Best Launch or Relaunch Campaign', 'Best Local Brand Campaign',
    'Best Local Execution of a Brand', 'Best Music Marketing Campaign',
    ...
    'Best Search Campaign', 'Best Publishing Brand', 'The Creative Media Award',
  ],
  'MMA Smarties APAC': [
  ...
  // 2026 list, 50 categories, from the organizer's 2026 entry form (read
  // 14 Sep 2026). 2027 not yet published. Campaign categories 1-15 use
  // question set C, culture 16-20 set D, agency/team/people 21-50 set E.
  'UK Agency Awards': [
    ...
    'Agency Growth & Transformation Award',
