...
export const DEADLINES_2026: ShowDeadline[] = [
  ...
  },
  {
    ...
    prValue: 38,
    note: 'MENA\'s premier show; Cannes Lions affiliate (Lions by Informa). Entries opened 9 Oct 2025; late fee after 11 Dec; second fee tier after 15 Jan; final deadline 22 Jan. Awards Ceremony 1 Apr 2026. Fees $575–$1,170 by Lynx/category/deadline. Jury 2026: ~65 jurors across 11 category groups (11 jury presidents). First-time representation from Costa Rica, Uganda, Uzbekistan; 20+ markets total. ⚠️ 2026 winner statistics NOT PUBLISHED on public pages despite ceremony occurring 1 Apr 2026 — anomalous. May be gated behind Lions press portal (press.canneslions.com). Recommend: email press@dubailynx.com or check Lions press portal. Prior year benchmarks: 2024: 1,676 entries → 361 shortlisted (~21.6%); 2023: 1,862 entries → 404 shortlisted (~21.7%). WIN_RATES.shortlist of 22% aligns with prior year data.',
    confidence: 'partial', lastVerified: '2026-06-03',
  },
  {
